...
const blobs = [
  ...
  },
  {
    style: {
      ...
      height: 100,
      background:
        "radial-gradient(circle at 35% 30%, #ccc5bb 0%, #a09890 40%, #606060 75%, #282828 100%)",
      borderRadius: "50%",
      bottom: "20%",
      right: "14%",
      boxShadow:
        "inset -6px -6px 16px rgba(0,0,0,0.15), 2px 4px 14px rgba(0,0,0,0.15)",
      opacity: 0.45,
    },
    animate: { y: [0, 8, 0] },
    duration: 8,
...
export default function Statement() {
  return (
    <section className="relative py-28 px-6 bg-[#ede8e0] overflow-hidden">
      {blobs.map((blob, i) => (
        <motion.div
          key={i}
